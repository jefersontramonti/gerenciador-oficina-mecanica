  ...
  if (isLoading) {
    return (
      <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-3">
        {[1, 2, 3].map((i) => (
          <div key={i} className="animate-pulse rounded-lg bg-white dark:bg-gray-800 p-4 sm:p-6 shadow">
  ...
  return (
    <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-3">
      ...
      <div className="rounded-lg bg-white dark:bg-gray-800 p-4 sm:p-6 shadow border border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between gap-2">
          <div className="min-w-0">
            <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">Total Pago</p>
      ...
      <div className="rounded-lg bg-white dark:bg-gray-800 p-4 sm:p-6 shadow border border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between gap-2">
          <div className="min-w-0">
            <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">Total Pendente</p>
      ...
      <div className="rounded-lg bg-white dark:bg-gray-800 p-4 sm:p-6 shadow border border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between gap-2">
          <div className="min-w-0">
            <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">Status</p>
            <p
          ...
          <div
            className={`rounded-full p-2 sm:p-3 shrink-0 ${
