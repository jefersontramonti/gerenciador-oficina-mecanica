/**
 * Página de registro de nova oficina
 */
...
export const RegisterPage = () => {
  ...
  const onSubmit = async (data: RegisterFormData) => {
    try {
      ...
      // Registra o usuário com perfil ADMIN (primeira conta da oficina)
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-gray-900 to-black px-4 py-8">
      ...
      <div className="w-full max-w-md rounded-xl border border-gray-700 bg-gray-800 p-8 shadow-2xl">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-gray-400">Configure sua oficina no PitStop</p>
        </div>
        ...
        <div className="mb-6 flex items-start gap-2 rounded-lg border border-blue-800 bg-blue-900/20 p-3 text-sm text-blue-400">
          <CheckCircle className="h-5 w-5 flex-shrink-0" />
          <div>
            <p className="font-medium">Conta Administrativa</p>
            <p className="mt-1 text-xs text-blue-300">
              A primeira conta criada terá permissões de administrador para gerenciar sua oficina.
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="space-y-5">
            ...
            {/* Campo Nome da Oficina/Responsável */}
            <div>
              <label htmlFor="nome" className="mb-2 block text-sm font-medium text-gray-300">
              ...
              <input
                ...
                type="text"
                id="nome"
                placeholder="João Silva / Oficina Silva"
            ...
            <div>
              <label htmlFor="confirmarSenha" className="mb-2 block text-sm font-medium text-gray-300">
                Confirmar Senha
              </label>
              <input
