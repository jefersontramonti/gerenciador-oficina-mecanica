...
@AllArgsConstructor
@Builder
@Schema(description = "Dados para criação de um novo fornecedor")
public class CreateFornecedorRequest {

    @Schema(description = "Tipo de fornecedor", example = "DISTRIBUIDOR", required = true)
    @NotNull(message = "Tipo de fornecedor é obrigatório")
    private TipoFornecedor tipo;

    @Schema(description = "Nome fantasia do fornecedor", example = "Auto Peças Brasil", required = true)
