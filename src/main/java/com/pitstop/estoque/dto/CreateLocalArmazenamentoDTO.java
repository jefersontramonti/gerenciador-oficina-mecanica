...
/**
 * DTO para criação de novos locais de armazenamento.
 *
 * @author PitStop Team
 * @version 1.0
 * @since 2025-11-02
 */
@Schema(description = "Dados para criação de um novo local de armazenamento")
public record CreateLocalArmazenamentoDTO(
