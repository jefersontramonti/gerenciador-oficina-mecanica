...
public record ComunicadoOficinaDetailDTO(
    UUID id,
    String titulo,
    String resumo,
    String conteudo,
    ...
    public static ComunicadoOficinaDetailDTO fromEntity(ComunicadoLeitura leitura) {
        Comunicado c = leitura.getComunicado();
        return new ComunicadoOficinaDetailDTO(
            c.getId(),
            c.getTitulo(),
            c.getResumo(),
            c.getConteudo(),
