-- V031: Fix existing admin user to have oficinaId (CORRECTED WITH UUID CAST)
...
INSERT INTO oficinas (
    ...
    '0f111111-1111-1111-1111-111111111111'::uuid,
...
UPDATE usuarios
SET oficina_id = '0f111111-1111-1111-1111-111111111111'::uuid
